...
@section('content')
  <div class="2xl:flex 2xl:space-x-[48px]">
        <section class="mb-6 2xl:mb-0 shadow-lg 2xl:flex-1">
            <!-- total widget-->
            <div class="mb-[24px] w-full">
                ...
                <div class="rounded-lg bg-white p-5 dark:bg-darkblack-600">
                    ...
                    <div class="flex items-center space-x-[7px]">
                        ...
                        <span>
                            <img
                            src="images/icons/total-earn.svg"
                            alt="icon"
                            />
                        </span>
                        </div>
                    ...
                    <div>
                        <img
                        src="images/avatar/members-2.png"
                        alt="members"
                        />
                    </div>
                    </div>
                ...
                <div class="rounded-lg bg-white p-5 dark:bg-darkblack-600">
                    ...
                    <div>
                        <a href="#" class="bg-indigo-700 dark:text-white">View</a>
                    </div>
                    </div>
                    <div class="flex items-end justify-between">
                    <div class="flex-1">
            ...
            <div class="mb-[24px] w-full xl:flex xl:space-x-[24px]">
                ...
                >
                    ...
                    >
                        ...
                        <span>
                        <svg
                            class="stroke-slate-900 dark:stroke-slate-900"
                            width="16"
                            height="17"
                            viewBox="0 0 16 17"
                            fill="none"
                ...
                <div class="rounded-lg bg-white dark:bg-darkblack-600">
                    ...
                    <div class="mb-4 flex items-center space-x-8">
                        ...
                        <div>
                            ...
                            <span>
                                <svg
                                class="fill-slate-900 dark:fill-bgray-50"
                                width="14"
                                height="12"
                                viewBox="0 0 14 12"
                                fill="none"
            ...
            <div class="w-full rounded-lg bg-white px-[24px] py-[20px] dark:bg-darkblack-600">
                ...
                <div class="flex h-[56px] w-full space-x-4">
                    ...
                    >
                        ...
                        <span>
                            <svg
                            class="stroke-slate-900 dark:stroke-success-400"
                            width="18"
                            height="17"
                            viewBox="0 0 18 17"
                            fill="none"
                ...
                <div class="table-content w-full overflow-x-auto">
                    ...
                    >
                        ...
                        <div class="flex w-full items-center space-x-2.5">
                            ...
                            >
                            <img
                                src="images/avatar/user-40x40.png"
                                alt="avatar"
                    ...
                    >
                        ...
                        <div class="flex w-full items-center space-x-2.5">
                            ...
                            >
                            <img
                                src="images/avatar/user-40x40-1.png"
                                alt="avatar"
                                class="h-full w-full object-cover"
                            />
                            </div>
                    ...
                    >
                        ...
                        <div class="flex w-full items-center space-x-2.5">
                            ...
                            >
                            <img
                                src="images/avatar/user-40x40-2.png"
                                alt="avatar"
                                class="h-full w-full object-cover"
                            />
                            </div>
            ...
            <div class="mb-6 w-full rounded-lg bg-white px-[42px] py-5 dark:border dark:border-darkblack-400 dark:bg-darkblack-600 lg:mb-0 lg:w-1/2 2xl:mb-6 2xl:w-full">
                ...
                <div class="flex justify-center">
                    ...
                    <div class="w-full">
                        <img
                        src="images/payments/card-1.svg"
                        alt="card"
                        />
                    </div>
                    <div class="w-full">
                        <img
                        src="images/payments/card-2.svg"
                        alt="card"
                        />
                    </div>
                    <div class="w-full">
                        <img
                        src="images/payments/card-3.svg"
                        alt="card"
                        />
                    </div>
                    </div>
                ...
                <div class="payment-select relative mb-3">
                    ...
                    <div class="flex items-center space-x-2">
                        <span>
                        <img
                            src="images/payments/master-mini.svg"
                            alt="master"
                        />
                        </span>
                        <span
                ...
                >
                    ...
                    <div>
                        <img
                        src="images/avatar/members-3.png"
                        alt="members"
                        />
                    </div>
                    </div>
            ...
            <div class="flex w-full flex-col justify-between rounded-lg bg-white dark:border dark:border-darkblack-400 dark:bg-darkblack-600 lg:w-1/2 2xl:w-full">
                ...
                <div class="mb-5 flex flex-col space-y-[32px]">
                    ...
                    <div class="flex items-end space-x-3">
                        ...
                        <div>
                            <img
                            src="images/others/mp3.png"
                            class="block dark:hidden"
                            alt="mp3"
                            />
                            <img
                            src="images/others/mp3-dark.png"
