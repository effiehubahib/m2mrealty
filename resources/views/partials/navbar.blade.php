<div class="w-full bg-white border-b border-slate-200 sticky top-0 z-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="flex items-center justify-between h-20">
        ...
        <nav class="hidden xl:flex items-center gap-8" aria-label="Primary">
          ...
          @php
            $navLinks = [
              ...
              ['route' => 'developments',  'label' => 'Developments'],
        ...
        <div class="flex items-center gap-3 sm:gap-5">
          ...
          <a href="{{ route('properties') }}" class="hidden md:inline-flex items-center justify-center bg-cyan-500 hover:bg-cyan-600 text-white font-medium text-[15px] px-5 py-2.5 rounded-md shadow-sm transition-colors">List Property</a>
    ...
    >
      <nav class="flex flex-col px-6 py-4 gap-1">
        ...
        <a href="{{ route('properties') }}" class="mt-3 inline-flex items-center justify-center bg-cyan-500 hover:bg-cyan-600 text-white font-medium text-[15px] px-5 py-2.5 rounded-md shadow-sm transition-colors">List Property</a>
      </nav>
    </div>
</div>
