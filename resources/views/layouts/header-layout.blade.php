...
<header class="header-wrapper fixed z-30 hidden w-full md:block">
    <div class="relative flex h-[108px] w-full items-center justify-between bg-white px-10 dark:bg-darkblack-600 2xl:px-[76px]">
        <button title="Ctrl+b" type="button" class="drawer-btn absolute left-0 top-auto rotate-180 transform">
            <span>
                <svg width="16" height="40" viewBox="0 0 16 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 10C0 4.47715 4.47715 0 10 0H16V40H10C4.47715 40 0 35.5228 0 30V10Z" fill="#06b6d4"/>
        ...
        <div class="px flex h-[56px] w-[300px] items-center justify-between rounded-lg border border-transparent  lg:w-[400px]">
        ...
        <div class="flex items-center space-x-[43px]">
            <div class="hidden items-center space-x-2 mx-0 xl:flex">
                <button type="button" id="theme-toggle" class="mr-0 relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-orange-300 dark:border-darkblack-400">
                    <span class="block dark:hidden">
                    <svg
                        class="stroke-slate-900 dark:stroke-bgray-50"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
                    ...
                    <svg
                        ...
                        height="24"
                        viewBox="0 0 24 24"
                        fill="stroke-slate-900 dark:stroke-bgray-50"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                ...
                <button onclick="notificationAction()" id="notification-btn" type="button" class="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-orange-300 dark:border-darkblack-400">
                    <span
                    ...
                    <svg
                    class="fill-slate-900 dark:stroke-bgray-50"
                    width="24"
                    height="25"
                    viewBox="0 0 24 25"
                    fill="none"
                ...
                <button onclick="messageAction()"
                    type="button"
                    id="message-btn"
                    class="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-orange-300 dark:border-darkblack-400">
                    <span
                ...
                <button
                    onclick="storeAction()" type="button" id="store-btn" class="relative flex h-[52px] w-[52px] items-center justify-center rounded-[12px] border border-orange-300 dark:border-darkblack-400">
                    <span class="absolute -right-[5px] -top-[2px] h-3.5 w-3.5 rounded-full border-2 border-white bg-bgray-300 dark:border-none dark:bg-bgray-600"></span>
                    <svg
                    class="stroke-slate-900 dark:stroke-bgray-50"
                    width="24"
                    height="24"
            ...
            <div onclick="profileAction()" class="flex cursor-pointer space-x-0 lg:space-x-3">
                ...
                @if(auth()->user()->profilephoto)
                    <img class="object-cover" src="{{ asset('storage/employee-profile/' . auth()->user()->profilephoto) }}" alt="Employee Photo">
                @else
                    <img class="object-cover" src="{{asset('images/no-image.jpg')}}" alt="Employee Photo"/>
                ...
                <div class="hidden 2xl:block">
                    ...
                    <h3
                        class="text-base font-bold leading-[28px] text-bgray-900 dark:text-bgray-50"
                    >
                        {{auth()->user()->fullname}}
                    </h3>
                    <span>
                    ...
                    >
                    @isset(auth()->user()->employeeRecord){{auth()->user()->employeeRecord->position}}@endisset
                    </p>
                </div>
            </div>
        </div>
            ...
            <div id="notification-box" style="filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));" class="absolute -left-[347px] top-[81px] hidden w-[400px] rounded-lg bg-white dark:bg-darkblack-600">
                <div class="relative w-full pb-[75px] pt-[66px]">
                    <div class="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
                        <h3 class="text-xl font-bold text-bgray-900 dark:text-bgray-50">
                            Notifications
                        </h3>
                        <span>
                            <svg
        ...
        <div class="message-popup-wrapper">
            ...
            class="fixed -left-[43px] top-0 hidden h-full w-full"
            ></div>
            <div id="message-box" style=" filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));" class="absolute -left-[276px] top-[81px] hidden w-[400px] rounded-lg bg-white dark:bg-darkblack-600">
                <div class="relative w-full pb-[75px] pt-[66px]">
                    <div class="absolute left-0 top-0 flex h-[66px] w-full items-center justify-between px-8">
                        <h3 class="text-xl font-bold text-bgray-900 dark:text-bgray-50">
                            Message
                ...
                <div class="flex items-center border-b border-bgray-200 dark:border-darkblack-400">
                    <button
                    type="button"
                    class="flex space-x-2 border-b-2 border-orange-300 px-6 py-4 text-sm font-semibold capitalize text-success-300"
                    >
                    <span>All</span>
                    <span
                    ...
                    <ul class="scroll-style-1 h-[335px] w-full overflow-y-scroll">
                        ...
                        <a href="#">
                            ...
                            <div class="flex-1">
                                <p
                                class="mb-1 text-base font-bold text-bgray-900  dark:text-bgray-50"
                                >
                                James Eusobio
                                </p>
                                <p
                ...
                <ul>
                    ...
                    <a href="{{route('my-profile')}}">
                        ...
                        <div class="w-[20px]">
                            <span>
                            <svg
                                class="stroke-slate-900 dark:stroke-slate-50"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
