<header class="mobile-wrapper fixed z-20 block w-full md:hidden">
    <div class="flex h-[80px] w-full items-center justify-between bg-white dark:bg-darkblack-600">
        <div class="flex h-full w-full items-center space-x-5">
            ...
            <div>
                <a href="/">
                    <img class="block dark:hidden size-16" src="{{asset('assets/images/logo.jpg')}}" alt="Jojo Bragais ERP"/> 
                    <img class="hidden dark:block size-16" src="{{asset('assets/images/logo.jpg')}}" alt="Jojo Bragais ERP"/> 
                </a>
            </div>
        </div>
        <div class="mr-2">
        ...
        <div class="profile-wrapper">
            <div onclick="profileAction()"class="profile-outside fixed -left-[43px] top-0 hidden h-full w-full"></div>
                <div style="filter: drop-shadow(12px 12px 40px rgba(0, 0, 0, 0.08));" class="profile-box absolute right-0 top-[81px] hidden w-[300px] overflow-hidden rounded-lg bg-white">
